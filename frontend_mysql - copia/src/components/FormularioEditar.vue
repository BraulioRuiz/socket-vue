...
export default {
   ...
   mounted: function(){   
        ...
        this.id_settings=this.$route.query.id; 
        API.get(('settings/').concat(this.id_settings)).then((response)=>{
            this.titulo= response.data.name;
            this.basedatos= response.data.name_db;
            this.usuario=response.data.user_db;
            this.contraseña=response.data.password_db;
            this.descripcion=response.data.decription;
            this.fecha=response.data.date_backup;
   ...
   methods : {
       submit () {
        this.$validator.validateAll().then(valid =>{
            if(valid){
                API.put(('settings/').concat(this.id_settings),{                    
                    name: this.titulo,  
